...
#' @param lr the \code{transition.structure}
#' @param bl the \code{transition.structure}
#' @param history the \code{transition.structure}
#' @title Index of blocks and states
