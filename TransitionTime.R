...
#which(timeToTrans == TRUE, arr.ind = TRUE)
 ...
 timeToTrans[32, 33] = TRUE
 timeToTrans[38,39] = TRUE
 timeToTrans[44,45] = TRUE
 
 
 
###########################################
 # Acute or Chronic to Diagnosed
 for (i in 0:2)
   timeToTrans[32 + 6 * i, 33 + 6 * i] = TRUE
 
 timeToTrans[1,11] = TRUE
 timeToTrans[2,12] = TRUE
 timeToTrans[3,13] = TRUE
 timeToTrans[4,14] = TRUE
 timeToTrans[5,15] = TRUE
